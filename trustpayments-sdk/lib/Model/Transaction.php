...
class Transaction implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \TrustPayments\Sdk\Model\CustomersPresence $customers_presence The customer's presence indicates what kind of authentication methods can be used during the authorization of the transaction. If no value is provided, 'Virtually Present' is used by default.
     *
     * @return $this
     */
     ...
     * Sets state
     *
     * @param \TrustPayments\Sdk\Model\TransactionState $state 
     *
     * @return $this
     */
