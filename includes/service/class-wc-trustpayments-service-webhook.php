...
/**
 *
 * WC_TrustPayments_Service_Webhook Class
 *
 * TrustPayments
...
class WC_TrustPayments_Service_Webhook extends WC_TrustPayments_Service_Abstract {
	...
	public function __construct() {
		$this->webhook_entities[1487165678181] = new WC_TrustPayments_Webhook_Entity(
			1487165678181,
			'Manual Task',
			array(
		...
		$this->webhook_entities[1472041857405] = new WC_TrustPayments_Webhook_Entity(
			1472041857405,
			...
			'WC_TrustPayments_Webhook_Method_Configuration',
			true
		);
		$this->webhook_entities[1472041829003] = new WC_TrustPayments_Webhook_Entity(
			1472041829003,
			'Transaction',
			array(
		...
		$this->webhook_entities[1472041819799] = new WC_TrustPayments_Webhook_Entity(
			1472041819799,
			'Delivery Indication',
			array(
		...
		$this->webhook_entities[1472041816898] = new WC_TrustPayments_Webhook_Entity(
			1472041816898,
			'Transaction Invoice',
			array(
		...
		$this->webhook_entities[1472041831364] = new WC_TrustPayments_Webhook_Entity(
			1472041831364,
		...
		$this->webhook_entities[1472041867364] = new WC_TrustPayments_Webhook_Entity(
			1472041867364,
			'Transaction Void',
			array(
		...
		$this->webhook_entities[1472041839405] = new WC_TrustPayments_Webhook_Entity(
			1472041839405,
			'Refund',
			array(
		...
		$this->webhook_entities[1472041806455] = new WC_TrustPayments_Webhook_Entity(
			1472041806455,
			'Token',
			array(
				\TrustPayments\Sdk\Model\CreationEntityState::ACTIVE,
		...
		$this->webhook_entities[1472041811051] = new WC_TrustPayments_Webhook_Entity(
			1472041811051,
			'Token Version',
			array(
	 ...
	 *
	 * @param WC_TrustPayments_Webhook_Entity     $entity entity.
	 * @param int                                         $space_id space id.
	 * @param \TrustPayments\Sdk\Model\WebhookUrl $webhook_url webhook url.
	 *
