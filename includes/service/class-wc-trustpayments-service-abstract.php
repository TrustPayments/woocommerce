...
abstract class WC_TrustPayments_Service_Abstract {
	 ...
	 *
	 * @param \TrustPayments\Sdk\Model\DatabaseTranslatedString $translatedString
	 * @return string[]
	 */
	protected function get_translations_array(\TrustPayments\Sdk\Model\DatabaseTranslatedString $translatedString){
		$translations = array();
