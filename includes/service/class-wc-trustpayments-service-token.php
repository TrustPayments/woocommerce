...
/**
 *
 * WC_TrustPayments_Service_Token Class
 *
 * TrustPayments
 ...
 *
 * @class WC_TrustPayments_Service_Token
 */
class WC_TrustPayments_Service_Token extends WC_TrustPayments_Service_Abstract {
	...
	protected function update_info( $space_id, TokenVersion $token_version ) {
		...
		$payment_method = WC_TrustPayments_Entity_Method_Configuration::load_by_configuration(
			$space_id,
	 ...
	 *
	 * @return \TrustPayments\Sdk\Service\TokenService TokenService.
	 */
