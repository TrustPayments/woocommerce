...
/**
 *
 * WC_TrustPayments_Entity_Token_Info Class
 *
 * TrustPayments
 ...
 */
class WC_TrustPayments_Entity_Token_Info extends WC_TrustPayments_Entity_Abstract {
	...
	protected static function get_field_definition() {
		return array(
			'token_id' => WC_TrustPayments_Entity_Resource_Type::INTEGER,
			'state' => WC_TrustPayments_Entity_Resource_Type::STRING,
			'space_id' => WC_TrustPayments_Entity_Resource_Type::INTEGER,
			'name' => WC_TrustPayments_Entity_Resource_Type::STRING,
			'customer_id' => WC_TrustPayments_Entity_Resource_Type::INTEGER,
	 ...
	 * @return WC_TrustPayments_Entity_Token_Info
	 */
