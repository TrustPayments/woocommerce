...
/**
 *
 * WC_TrustPayments_Entity_Refund_Job Class
 *
 * TrustPayments
 ...
 * @method \TrustPayments\Sdk\Model\RefundCreate get_refund()
 * @method void set_refund( \TrustPayments\Sdk\Model\RefundCreate  $refund)
 * @method void set_failure_reason(map[string,string] $reasons)
 */
class WC_TrustPayments_Entity_Refund_Job extends WC_TrustPayments_Entity_Abstract {
	...
	protected static function get_field_definition() {
		return array(
			'external_id'    => WC_TrustPayments_Entity_Resource_Type::STRING,
			...
			'wc_refund_id'   => WC_TrustPayments_Entity_Resource_Type::INTEGER,
			'refund'         => WC_TrustPayments_Entity_Resource_Type::OBJECT,
