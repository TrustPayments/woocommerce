...
/**
 *
 * WC_TrustPayments_Entity_Completion_Job Class
 *
 * TrustPayments
...
/**
 * Class WC_TrustPayments_Entity_Completion_Job.
 *
 * @class WC_TrustPayments_Entity_Completion_Job
 */
/**
 ...
 */
class WC_TrustPayments_Entity_Completion_Job extends WC_TrustPayments_Entity_Abstract {
	...
	protected static function get_field_definition() {
		return array(
			'completion_id' => WC_TrustPayments_Entity_Resource_Type::INTEGER,
			...
			'amount' => WC_TrustPayments_Entity_Resource_Type::DECIMAL,
			'items' => WC_TrustPayments_Entity_Resource_Type::OBJECT,
			'restock' => WC_TrustPayments_Entity_Resource_Type::BOOLEAN,
