...
<?php
	...
	public function process_payment($order_id){
	    ...
	    $space_id = sanitize_text_field($_POST['trustpayments-space-id-'.$this->id]);
	    $transaction_id = sanitize_text_field($_POST['trustpayments-transaction-id-'.$this->id]);
	    $transaction_nonce = sanitize_text_field($_POST['trustpayments-transaction-nonce-'.$this->id]);
