...
class WC_TrustPayments_Migration {
	...
	public static function plugin_row_meta( $links, $file ) {
		if ( WC_TRUSTPAYMENTS_PLUGIN_BASENAME === $file ) {
			$row_meta = array(
				'docs' => '<a href="https://plugin-documentation.ep.trustpayments.com/TrustPayments/woocommerce/2.1.15/docs/en/documentation.html" aria-label="' . esc_attr__( 'View Documentation', 'woo-trustpayments' ) . '">' . esc_html__( 'Documentation', 'woo-trustpayments' ) . '</a>',
			);
